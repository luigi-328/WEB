              ...
              <form>
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input id="indirizzo" type="text" class="form-control" required="required">
                  </div>
                  <div class="form-group">
                    <label>Citta'</label>
                    <input id="citta" type="text" class="form-control" required="required">
                  </div>
                  <div class="form-group">
                    <label>Cap</label>
                    <input id="cap" type="text" class="form-control" required="required">
                  </div>

                </div>
                <div class="modal-footer justify-content-between">
                  <button id="aggiungi" type="button" class="btn btn-primary" name="${usernameLogged}">Aggiungi questo
                    indirizzo</button>
