  ...
  <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <body>
      ...
      <div class="container-fluid contact-header">
        <h1>Contattaci</h1>
        <p style="color: gray">
          Hai bisogno di aiuto? Compila il form qui sotto.
        </p>
      </div>
      ...
      <div class="contact-form">
        <form class="email-form">
          <div class="form-group">
            ...
            <input type="email" class="form-control" id="email" placeholder="nome_utente@dominio.com" />
          </div>
          <div class="form-group">
          ...
          <div id="contact-form" class="form-group">
            <label id="email-input" for="exampleFormControlTextarea1">Messaggio</label>
            <textarea id="TextArea" class="form-control" rows="3"
              placeholder="Descrivi il tuo problema..."></textarea>
          </div>
        </form>
        <div class="send-btn-container">
          <button id="send-btn" class="btn send-btn">Invia</button>
        </div>
      </div>
      <div id="alert">
