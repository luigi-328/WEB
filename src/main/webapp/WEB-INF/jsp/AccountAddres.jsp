<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
  <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <head>
      ...
      <script src="../../js/accountaddress.js"></script>
      ...
      <div class="content-page">
        ...
        <div class="container-menu">
          <ul class="menu" style="line-height:400%">
            ...
            <li class="controlList-item ">
              <a href="/accountAddres" id="address-nav-link">Indirizzi di consegna</a>
            </li>
          </ul>
        </div>
        ...
        <div class="principale">
          ...
          <div class=divIndirizzi>
            ...
            <div id="divbottone" class=divIndirizzi>
              <!-- indirizzi aggiunti da interfaccia -->
            </div>
          ...
          <div class="form-aggiunta">
            ...
            <div class="form-group">
              <input class="form-control" type="text" id="nominativo" name="nominativo" placeholder="Nominativo"
                required>
            </div>

            <div class="form-group">
              <input class="form-control" type="text" id="indirizzo" name="indirizzo" placeholder="Indirizzo" required>
            </div>

            <div class="form-group">
              <input class="form-control" type="text" id="citta" name="citta" placeholder="Citta'" required>
            </div>

            <div class="form-group">
              <input class="form-control" type="text" id="cap" name="cap" placeholder="Inserisci il tuo cap" required>
            </div>


            <!--	<div class="form-group">
							<input class="form-control" type="text" id="nome" placeholder="Inserisci il tuo nome">
						</div>
						<div class="form-group">
							<input class="form-control" type="text" id="cognome" placeholder="Inserisci il tuo cognome">
						</div>
						<div class="form-group">
							<input class="form-control" type="text" id="telefono" placeholder="Inserisci il tuo telefono">
						</div> -->
            <button id="aggiungi_ind" name="${usernameLogged}" class="modifica">Conferma indirizzo</button>
